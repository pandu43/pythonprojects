...
for pamp in pulse_amplitudes:
    ...
    for i in range(num_outputs):
        ...
        exp_file = "/home/lavanya/Documents/time vs R exp data.ods"
        ...
        plt.loglog(x1, y1, '-', color='red', label='0.6V')
        plt.loglog(x2, y2, '-', color='red', label='0.7V')
        plt.loglog(x3, y3, '-', color='red', label='0.8V')
