...
MaxNoSteps = 1000
Eb_Cr = 3.2#  3.2 ev,3.2
Eb_An = 2.4# 3.0  ev,2.8
...
y0 =  -150#175
A = 1201.8
xc = 3.25 #3.01 Mean value as xc
w = 0.15   # 0.117Standard deviation as w
...
print("ComplianceCurrent", Compliance_Current )
...
for i in range(num_outputs):
    ...
    exp_file = "/home/lavanya/Documents/1e-5,1e-3 IV sim and exp data.ods"
