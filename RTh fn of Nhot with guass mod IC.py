...
def KmcProcess_FWReset(RampRate, Thickness, NoOfColdspots , NoOfHotspots,NoOfVacancies,
    ...
    while (AppliedBias <= 1.88):
       ...
       # print(" Vreset value", Vreset)

        #print("Rth reset value", Rth)
...
output_folder = "Rth fn of Nhot with guassmod Ic"
...
for i in range(num_outputs):
    ...
    timeSet, NoOfColdspotsFS, NoOfHotspotsFS, AppliedBiasFS = KmcProcess_FWSet (RampRate,
                                                                               ...
                                                                               Eb_Cr, alpha_Cr_Set,
                                                                               AppliedBias,
                                                                               alpha_An1_Set,alpha_An2_Set, ResetExpo_Set,Eb_An,i)
