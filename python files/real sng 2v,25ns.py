...
#res_df = pd.read_csv("/home/lavanya/Documents/HRS_2v ,25ns.csv")
...
output_file = "BSL_Error_Metrics2V,25ns.xlsx"
...
df_acc.to_csv('accuracy_vs_BSL_realSNG2V,25ns.csv', index=False)
print("CSV file saved as 'accuracy_vs_BSL_realSNG2V,25ns.csv'")
