...
nu0_Set = 1e5   #1e5
nu01_Set = 1e3 #1e3
alpha_Cr_Set = 9.5e-10 #9.5e-10 ,6.8e-10
alpha_An2_Set = 1e-9  # 1e-9,6.8e-10
...
nu0_Reset = 1e5  #1e5
nu01_Reset = 5e4#1e3
alpha_Cr_Reset = 9.5e-10#9.5e-10 ,1e-10
alpha_An2_Reset = 1.67e-9# 1.5e-9,1.2e-9
alpha_An1_Reset = 1e14# 1e14,1e10
...
NoOfColdspots =   ExpectedNumberOfVacancies
NoOfHotspots= 1
...
for i in range(num_outputs):
    ...
    for j, bias_limit in enumerate(bias_limits):
        ...
        NoOfHotspotsBS = NoOfHotspotsFR
        NoOfColdspotsBS = NoOfColdspotsFR
        AppliedBiasBS =  AppliedBiasFR
   ...
   # plt.legend()
    # --- Read experimental data from ODS file ---
        exp_file = "/home/lavanya/Documents/multi level reset exp data.ods"
